        ...
        <Flex paddingTop={16} flexDir={{ md: 'row', base: 'column' }}>
          ...
          <Box flex={2}>
            <Text fontSize='lg'>
              ...
              to build a wireless, affordable, miniature neural stimulator that
              researchers can feasibly get and perform experiments with to
              better understand the use of neural stimulation in treating
              illnesses like Parkinson's, chronic pain, epilepsy and depression.
            </Text>
          </Box>
        </Flex>
        <Flex paddingTop={16} flexDir={{ md: 'row', base: 'column' }}>
          ...
          <Box flex={2}>
            <Text fontSize='lg'>
              Currently, commercial neural stimulators need to be tethered to
              the animal and to make the system as small as possible, a custom
              made ASIC (Application Specific Integrated Circuit) needs to be
        ...
        <Flex paddingTop={16} flexDir={{ md: 'row', base: 'column' }}>
          ...
          <Box flex={2}>
            <Text fontSize='lg'>
              ...
              open-sourced, making it possible to share newer functionality
